        ...
        <Box
          ...
          <Stack spacing={4}>
            ...
            <FormControl id="firstName" isRequired>
                ...
                <Input name="username" type="text" value={formState.name} onChange={handleChange}/>
            </FormControl>
            ...
            <FormControl id="password" isRequired>
              ...
              <InputGroup>
                <Input name="password" value={formState.password} onChange={handleChange} type={showPassword ? 'text' : 'password'} />
